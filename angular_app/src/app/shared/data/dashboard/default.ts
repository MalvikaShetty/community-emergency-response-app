...
export let overallCases: ChartOptions | any = {
  series: [
    {
      name: "Avg Cases per Day",
      data: [100, 30, 25, 40, 70, 32, 52, 96, 48, 90,79,80],
    },
  ],
  chart: {
    type: "bar",
  ...
  xaxis: {
    categories: ["Jan", "Feb", "Mar", "Aor", "May", "Jun", "Jul", "Aug", "Sept", "Oct", "Nov", "Dec"],
    labels: {
      style: {
        fontFamily: "Rubik, sans-serif",
      },
...
export let allLocations: ChartOptions | any = {
  series: [10],
  chart: {
    height: 290,
    type: "radialBar",
...
export let success: ChartOptions | any = {
  series: [
    {
      name: "Desktops",
...
export let cases: ChartOptions | any = {
  series: [
    {
      name: "Daily",
...
export let joinedpastmonthvolunteers = {
  icon: "return-box",
  counter: "10",
  name: "Monthly Join",
  path:"volunteers",
